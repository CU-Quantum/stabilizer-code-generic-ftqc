...
PARAMETERS = {
    "UniversalHadamardHelperCode": StateParameters(
        zero=ParametersForStateEncodingTest(
            code=UniversalHadamardHelperCode(num_qubits_in_cat_state=ExpectedStatesUniversalHadamardHelper().num_qubits),
            expected_state=ExpectedStatesUniversalHadamardHelper().get_logical_zero_state_vector(),
            initial_data_state=tensor(*[KET_ZERO_STATE_VECTOR] * ExpectedStatesUniversalHadamardHelper().num_qubits * ThreeCatCode.num_cats),
        ),
        one=ParametersForStateEncodingTest(
            code=UniversalHadamardHelperCode(num_qubits_in_cat_state=ExpectedStatesUniversalHadamardHelper().num_qubits),
            expected_state=ExpectedStatesUniversalHadamardHelper().get_logical_one_state_vector(),
            initial_data_state=tensor(*[KET_ONE_STATE_VECTOR] * ExpectedStatesUniversalHadamardHelper().num_qubits * ThreeCatCode.num_cats),
        ),
    ),
