...
QUBIT_INDICES_IN_DIFFERENT_POSITIONS_IN_DIFFERENT_CAT_PARITY_CODE_SUBREGISTERS = [
    0,
    ExpectedStatesGeneralizedShorCodeHadamard().num_qubits_per_cat + 1,
    ExpectedStatesGeneralizedShorCodeHadamard().num_qubits_per_cat * ExpectedStatesGeneralizedShorCodeHadamard().num_cats - 1
]
...
SINGLE_ERROR_PARAMETERS = {
    ...
    "CatParityCodeZeroState": ParametersForCorrectionsTest(
        ...
        initial_state=ExpectedStatesGeneralizedShorCodeHadamard().get_logical_zero_state_vector(),
    ...
    "CatParityCodeOneState": ParametersForCorrectionsTest(
        code=GeneralizedShorCodeHadamard(num_cats=ExpectedStatesGeneralizedShorCodeHadamard().num_cats,
                                         num_qubits_per_cat=ExpectedStatesGeneralizedShorCodeHadamard().num_qubits_per_cat),
        initial_state=ExpectedStatesGeneralizedShorCodeHadamard().get_logical_one_state_vector(),
        qubit_indices_to_test=QUBIT_INDICES_IN_DIFFERENT_POSITIONS_IN_DIFFERENT_CAT_PARITY_CODE_SUBREGISTERS
    ),
...
class TestCorrections:
    ...
    @pytest.mark.parametrize("params", [
        pytest.param((
                ...
                ExpectedStatesGeneralizedShorCodeHadamard(num_cats=5, num_qubits_per_cat=5).get_logical_zero_state_vector(),
