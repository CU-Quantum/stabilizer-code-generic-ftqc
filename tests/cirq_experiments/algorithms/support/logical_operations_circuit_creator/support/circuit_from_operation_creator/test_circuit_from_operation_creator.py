...
from cirq_experiments.custom_dataclasses.simulation_operation import SimulationOperation, TargetEncoding, LogicalEncodingIndex
...
from cirq_experiments.utilities.utilities import KET_ONE_STATE_VECTOR, KET_ZERO_STATE_VECTOR, \
    states_are_equal, tensor
from tests.cirq_experiments.algorithms.support.logical_operations_circuit_creator.support.circuit_from_operation_creator.error_correcting_code_stub_with_x_and_z import \
...
class TestCircuitFromOperationCreator:
    ...
    def test_create_circuit_with_controlled_operation(self):
        ...
        circuit = CircuitFromOperationCreator(operation=operation, operation_index=0).create_circuit()
    ...
    def test_create_circuit_with_no_encoding_raises_error(self):
        operation = SimulationOperation()
        creator = CircuitFromOperationCreator(operation=operation, operation_index=0)
