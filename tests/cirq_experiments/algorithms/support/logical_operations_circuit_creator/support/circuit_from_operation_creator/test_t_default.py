...
from cirq_experiments.custom_dataclasses.simulation_operation import SimulationOperation, TargetEncoding
...
from tests.cirq_experiments.support.universal_operations.universal_t.test_universal_t_instances import T_ROTATION
