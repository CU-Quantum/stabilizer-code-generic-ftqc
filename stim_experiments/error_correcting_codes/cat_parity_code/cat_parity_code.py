...
class CatParityCode(StabilizerCode):
    ...
    def _get_anticommuter_for_generator(self, generator_index: int) -> list[Operation]:
        ...
        if is_z_stabilizer:
            ...
            start_index = subregister_index * self._num_qubits_in_cat_state
            ...
            return [Z(self.data_qubits[i * self._num_qubits_in_cat_state]) for i in range(subregister_index + 1)]
