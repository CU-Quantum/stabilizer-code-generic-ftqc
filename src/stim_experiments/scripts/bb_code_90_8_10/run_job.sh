...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=bb_90_8_10
#SBATCH --error=results/bb_code_90_8_10/bb_code_90_8_10_%j.err
#SBATCH --output=results/bb_code_90_8_10/bb_code_90_8_10_%j.out
...
# Run
python /projects/nipa4599/stim-experiments/src/stim_experiments/scripts/bb_code_90_8_10/bb_code_90_8_10.py \
  -s 1_000_000_000 \
  -e 1000 \
