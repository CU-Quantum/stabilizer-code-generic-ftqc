...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=seventeen_qubit
#SBATCH --error=results/seventeen_qubit/seventeen_qubit_%j.err
#SBATCH --output=results/seventeen_qubit/seventeen_qubit_%j.out
...
# Run
python /projects/nipa4599/stim-experiments/src/stim_experiments/scripts/seventeen_qubit/seventeen_qubit.py \
  -s 1_000_000_000 \
  -e 1000 \
