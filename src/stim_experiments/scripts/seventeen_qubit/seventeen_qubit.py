...
from stim_experiments.simulate_cx.support.stabilizer_code_utilities import get_17_1_7_code_utilities
...
if __name__ == "__main__":
    ...
    SimulateQec(
        ...
        target_code=get_17_1_7_code_utilities(),
        num_cat_states=7,
        code_title='17-qubit Code',
