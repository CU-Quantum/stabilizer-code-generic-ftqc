...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --job-name=gsc_d5
#SBATCH --error=results/gscx_distance_5/gscx_distance_5_%j.err
#SBATCH --output=results/gscx_distance_5/gscx_distance_5_%j.out
...
# Run
python /projects/nipa4599/stim-experiments/src/stim_experiments/scripts/gscx_distance_5/gscx_distance_5.py \
  -s 100_000_000 \
  -e 500 \
