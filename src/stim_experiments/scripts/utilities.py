...
from stim_experiments.scripts import dodecacode, five_qubit, gscx_distance_7


def get_shard_merge_paths(files_in_dirs: Optional[list[str]] = None) -> dict[Path, list[Path]]:
    if files_in_dirs is None:
        files_in_dirs = [five_qubit.__file__, dodecacode.__file__, gscx_distance_7.__file__]
